      ...
      <div className="w-full py-12">
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-2 lg:grid-cols-3 xl:grid-cols-5 gap-3">
            ...
            <a
              href="/projects"
              className="group relative bg-gradient-to-br from-blue-50 to-blue-100/50 hover:from-blue-100 hover:to-blue-200/60 rounded-xl shadow-sm hover:shadow-md transition-all duration-300 p-4 border border-blue-200/50 hover:border-blue-300"
            >
            ...
            <a
              href="/apartments"
              className="group relative bg-gradient-to-br from-emerald-50 to-emerald-100/50 hover:from-emerald-100 hover:to-emerald-200/60 rounded-xl shadow-sm hover:shadow-md transition-all duration-300 p-4 border border-emerald-200/50 hover:border-emerald-300"
            >
              <div className="flex flex-col items-center text-center gap-2.5">
            ...
            <a
              href="/residential"
              className="group relative bg-gradient-to-br from-amber-50 to-amber-100/50 hover:from-amber-100 hover:to-amber-200/60 rounded-xl shadow-sm hover:shadow-md transition-all duration-300 p-4 border border-amber-200/50 hover:border-amber-300"
            >
              <div className="flex flex-col items-center text-center gap-2.5">
            ...
            <a
              href="/commercial"
              className="group relative bg-gradient-to-br from-purple-50 to-purple-100/50 hover:from-purple-100 hover:to-purple-200/60 rounded-xl shadow-sm hover:shadow-md transition-all duration-300 p-4 border border-purple-200/50 hover:border-purple-300"
            >
              <div className="flex flex-col items-center text-center gap-2.5">
            ...
            <a
              href="/lands"
              className="group relative bg-gradient-to-br from-teal-50 to-teal-100/50 hover:from-teal-100 hover:to-teal-200/60 rounded-xl shadow-sm hover:shadow-md transition-all duration-300 p-4 border border-teal-200/50 hover:border-teal-300"
            >
              <div className="flex flex-col items-center text-center gap-2.5">
