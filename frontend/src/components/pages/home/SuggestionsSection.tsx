      ...
      <div className="w-full mt-6 lg:hidden">
        ...
        >
          ...
          <div className="flex justify-center gap-2 mt-6">
            <CarouselPrevious className="static translate-y-0 bg-white shadow-md hover:bg-gray-50 border border-gray-200 w-10 h-10" />
            <CarouselNext className="static translate-y-0 bg-white shadow-md hover:bg-gray-50 border border-gray-200 w-10 h-10" />
          </div>
        </Carousel>
      </div>
      ...
      <div className="hidden w-full grid-cols-2 gap-6 mt-6 lg:grid lg:mt-0">
        {data.map((item, index) => (
          ...
          >
            ...
            <h2 className="mt-3 text-left text-gray-600 leading-relaxed">
              {item.text}
            </h2>
          </div>
        ))}
