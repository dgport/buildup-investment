      ...
      <div className="space-y-5">
        ...
        <div className="space-y-2">
          ...
          <div className="flex items-center justify-between gap-3 bg-gray-50 border border-gray-200 rounded-xl px-4 py-3">
            <p className={`text-sm truncate ${coords ? "font-mono text-teal-800" : "text-gray-500"}`}>
      ...
      <div className="space-y-5">
        ...
        <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 gap-2.5">
          {PROJECT_AMENITIES.map((key) => {
            ...
            return (
              <label key={key} className={`flex items-center gap-3 px-3 py-2.5 rounded-xl border cursor-pointer text-sm transition ${checked ? "bg-teal-50 border-teal-400 text-teal-950" : "bg-gray-50 border-gray-200 text-gray-700 hover:border-gray-300"}`}>
                <Checkbox
                  checked={checked}
                  onCheckedChange={(c) =>
