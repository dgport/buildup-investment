...
const PropertyCard = ({ property }: PropertyCardProps) => {
  ...
  const formatPrice = (priceUSD: number | null) => {
    ...
    const amount =
      currency === "USD" ? priceUSD : Math.round(priceUSD * exchangeRate);
  ...
  return (
    <div
      ...
      className="bg-white rounded-xl border-2 border-teal-900/30 hover:border-amber-400/60 transition-all duration-300 h-full w-full cursor-pointer shadow-lg hover:shadow-2xl overflow-hidden"
    >
      <div className="relative h-68 overflow-hidden bg-gray-100 border-b-2 border-teal-900/20">
        ...
        {property.hotSale && (
          <div className="absolute top-2 right-2 bg-gradient-to-r from-red-500 to-orange-500 rounded-lg px-3 py-1.5 shadow-lg flex items-center gap-1.5 z-20 animate-pulse border border-red-600">
